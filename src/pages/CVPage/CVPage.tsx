    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white px-4 md:px-20 py-20">
      ...
      <section className="mb-12 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="italic">
              BSc Applied Maths & Computer Science, Honours in Computer Science — 2018
            </p>
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>
                Worked on OCI (Oracle Cloud Infrastructure), Multicloud, and Edge Computing
                projects.
              </li>
              <li>
                Leveraged the following technologies and languages: Java, Python, Bash, Terraform,
                Ansible, TypeScript, React, Docker, Kubernetes, DropWizard.
              </li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>
                Worked in the in-store team developing software solutions for client operations.
              </li>
      ...
      <section className="mb-12 max-w-4xl mx-auto">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            Chess player — represented province at junior level; currently play for Observatory
            Chess Club.
          </li>
          <li>

  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
      <section className="flex flex-col items-center justify-center text-center py-20 px-4 md:px-20">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-4">Hi, I'm Guy Green</h1>
        <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-2xl mb-8">
          I'm a software developer passionate about building clean, efficient, and user-friendly
      ...
      <section className="py-20 px-4 md:px-20 bg-white dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
          <div className="p-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow hover:scale-105 transform transition">
            ...
            <p>
              Experienced in React, TypeScript, Node.js, Java, Python and building full-stack
              applications.
            </p>
          </div>
          <div className="p-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow hover:scale-105 transform transition">
            ...
            <p>
              I enjoy challenging myself with chess and strategic thinking, which also improves
              problem-solving skills in development.
            </p>
          </div>
          <div className="p-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow hover:scale-105 transform transition">
            <h3 className="text-2xl font-semibold mb-2">Continuous Learning</h3>
            <p>
              Always exploring new technologies, frameworks, and techniques to stay current and
              improve my craft.
            </p>
          </div>
          <div className="p-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow hover:scale-105 transform transition">
            ...
            <p>
              I enjoy staying active with padel, running, and football — which keeps me energized
              and balanced both mentally and physically.
            </p>
          </div>
        </div>
      </section>
